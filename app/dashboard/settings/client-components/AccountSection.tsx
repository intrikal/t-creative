 ...
 * - Delete account with confirmation dialog (calls a server action in Phase 2
 *   that removes the `profiles` row and revokes auth)
 */
...
/**
 * AccountSection — destructive actions live behind confirmation dialogs.
 * Log out and delete account are stubs until Phase 2 Supabase auth wiring.
 */
