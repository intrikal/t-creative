/**
 * TermsPage — Client Component rendering the Terms of Service page.
 *
...
export function TermsPage({ effectiveDate, intro, sections }: TermsPageProps) {
          ...
          <div className="mx-auto max-w-3xl">
            {sections.length === 0 ? (
              <motion.p
                ...
                transition={{ duration: 0.6 }}
              >
                Our terms of service are being updated. Please check back soon or contact us at{" "}
                <a
