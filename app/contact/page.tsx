...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = `Get in touch with T Creative Studio. Book an appointment, request a consultation, or ask about our services in ${location} and the Bay Area.`;
  return {
