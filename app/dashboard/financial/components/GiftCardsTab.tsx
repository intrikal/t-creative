...
export function GiftCardsTab({
  ...
  const [historyTarget, setHistoryTarget] = useState<GiftCardRow | null>(null);
  ...
  return (
    <>
      ...
      {historyTarget && (
        <GiftCardHistoryDialog open onClose={() => setHistoryTarget(null)} card={historyTarget} />
      )}
    </>
  );
}
